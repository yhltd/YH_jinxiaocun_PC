...
<body  style="    margin: 0;">
    <h1 style="margin-top:0px;margin-bottom:10px">社保</h1>
    ...
    <div>
        ...
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="部门详情"   CssClass="top_bt" style="margin-right:-10px" />
