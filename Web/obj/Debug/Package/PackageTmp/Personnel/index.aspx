...
<body  style="    margin: 0;">
    ...
    <form id="form1" runat="server" style="height:100%">
        <div class="header_login_info_con">
            ...
            <div style="width:23%">
                <span class="fl welcome_info" style="color:white;font-weight:bold;font-size:16px">你好！</span>
                <img src="../Personnel/images/用户.png" style="height:22px;width:22px;margin-right:-35px" />
                <span class="fl welcome_info" style="color:white;font-weight:bold;font-size:16px"><%=Session["username"] %></span>
