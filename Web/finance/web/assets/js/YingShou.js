...
function getList() {
    ...
    $.ajax({
        type: 'Post',
        url: "web_service/shouFuBaoBiao.asmx/getYS",
        beforeSend: function () {
            $.messager.progress({
                title: '提示',
                msg: '正在加载',
...
function setTable(data) {
    $('#data-table').datagrid({
        ...
        columns: [[
            ...
            { field: 'jine1', align: 'center', title: '应收', width: 150 },
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (result.code == 200) {
                ...
                console.log(header)
                title = ['往来单位', '项目', '摘要', '应收','往来单位','发票种类','发票号','金额']
                JSONToExcelConvertor(header, "应收报表", title)
            }
        },
        error: function (err) {
            alert("错误！")
