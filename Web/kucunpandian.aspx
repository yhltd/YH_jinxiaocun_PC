<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kucunpandian.aspx.cs" Inherits="Web.kucunpandian" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#insert").click(function () {
                ...
                newTr += "<td class='item_td' id='sp_cpsl" + row + "'></td>"
                newTr += "<td class='item_td' id='sp_sjsl" + row + "'><input id='sjsl" + row + "' name='sjsl" + row + "' type='number' autocomplete='off' class='table_input'/></td>"
            ...
            $("#insert_pd").click(function () {
                ...
                ruku.warehouse = warehouse;


                $.ajax({
                    type: "Post",
                    url: "kucunpandian.aspx",
                    data: {
                        act: "insert",
        ...
        function check(e, index) {
            ...
            if ($("#sjsl" + index).text() == "" && $("#sjsl" + index).val() == "") {
                alert("请输入实际数量")
                return false
            }
            return true
        ...
        function choice_ruku(e, index) {
            if (check(e, index)) {
                if ($("#checkbox" + index).is(":checked")) {
                    var item = { id: e, num: $("#num" + index).val(),kcsl: $("#sp_cpsl" + index).text(), sjsl: $("#sjsl" + index).val() };
        ...
        function setList(result) {
            ...
            for (var j = 0; j < result.length; j++) {
                ...
                insertStr += "<td class='item_td' id='sp_cpsl" + row + "' name='sp_cpsl" + row + "'>" + result[j].maxNum + "</td>"
                insertStr += "<td class='item_td' id='sp_sjsl" + row + "' name='sp_sjsl" + row + "'><input id='sjsl" + row + "' name='sjsl" + row + "' type='number' autocomplete='off' oninput='bindInput_price(this.value," + result[j].id + ")' class='table_input' /></td>"
...
<body>
        ...
        <div>
            ...
            <div class="d-main" id="table_div">
                ...
                <table id="biao_ge" name="bg_row" cellspacing="0" cellpadding="0">
                    <tr id="dj_yh">
                        <td class="auto-style1" style="width: 10%">盘点</td>
                        ...
                        <td class="auto-style1" style="width: 10%;">库存数量</td>
                        <td class="auto-style1" style="width: 10%;">实际数量</td>
    ...
    <div class="ruku_div" style="display:none">
        ...
        <div class="ruku_bottom_div">
            ...
            <input class="rk_bt" id="insert_pd" type="button" value="确认盘点"/>
        </div>
    </div>
