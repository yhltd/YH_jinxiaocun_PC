...
namespace Web.Server
{
    public class JinHuoFangModel
    {
        ...
        public List<yh_jinxiaocun_jinhuofang> getList(string gongsi)
        {
            if (HttpContext.Current != null && HttpContext.Current.Session["shujuku"] != null)
            {
                ...
                if (shujukuValue == 0) // MySQL
                {
                    ...
                    {
                        string sql = "select * from yh_jinxiaocun_jinhuofang where gongsi = @gongsi";
                        var result = sen.Database.SqlQuery<yh_jinxiaocun_jinhuofang>(sql, new MySqlParameter("@gongsi", gongsi));
                        return result.ToList();
                    }
                }
                else if (shujukuValue == 1) // SQL Server
                {
                    ...
                    {
                        string sql = "select * from yh_jinxiaocun_jinhuofang_mssql where gongsi = @gongsi";
                        var result = sen.Database.SqlQuery<yh_jinxiaocun_jinhuofang>(sql, new System.Data.SqlClient.SqlParameter("@gongsi", gongsi));
                        return result.ToList();
                    }
                }
            }
        ...
        //public List<yh_jinxiaocun_jinhuofang> getList_chaxun(string gongsi,string beizhu)
        //{
        //    using (ServerEntities sen = new ServerEntities())
        //    {
        //        string sql = "select * from yh_jinxiaocun_jinhuofang where gongsi = '" + gongsi + "' and beizhu like '%"+ beizhu +"%'";
        //        var result = sen.Database.SqlQuery<yh_jinxiaocun_jinhuofang>(sql);
        //        return result.ToList();
        //    }
        //}
        public List<yh_jinxiaocun_jinhuofang> getList_chaxun(string gongsi, string beizhu)
        {
            if (HttpContext.Current != null && HttpContext.Current.Session["shujuku"] != null)
            {
                ...
                else if (shujukuValue == 1) // SQL Server
                {
                    using (yh_jinxiaocun_excelEntities3 sen = new yh_jinxiaocun_excelEntities3())
                    {
                        string sql = "select * from yh_jinxiaocun_jinhuofang_mssql where gongsi = @gongsi and beizhu like @beizhu";
                        var result = sen.Database.SqlQuery<yh_jinxiaocun_jinhuofang>(sql,
        ...
        public int delete(int id)
        {
            if (HttpContext.Current != null && HttpContext.Current.Session["shujuku"] != null)
            {
                ...
                else if (shujukuValue == 1) // SQL Server
                {
                    using (yh_jinxiaocun_excelEntities3 sen = new yh_jinxiaocun_excelEntities3())
                    {
                        string sql = "delete from yh_jinxiaocun_jinhuofang_mssql where _id = @id";
            ...
            if (HttpContext.Current != null && HttpContext.Current.Session["shujuku"] != null)
            {
                ...
                if (shujukuValue == 0) // MySQL
                {
                    using (ServerEntities sen = new ServerEntities())
                    {
                        ...
                        foreach (yh_jinxiaocun_jinhuofang item in list)
                        {
                            sql += "insert into yh_jinxiaocun_jinhuofang(beizhu,lianxidizhi,lianxifangshi,finduser,gongsi) values (@beizhu" + paramIndex + ", @lianxidizhi" + paramIndex + ", @lianxifangshi" + paramIndex + ", @finduser" + paramIndex + ", @gongsi" + paramIndex + ");";
                ...
                else if (shujukuValue == 1) // SQL Server
                {
                    using (yh_jinxiaocun_excelEntities3 sen = new yh_jinxiaocun_excelEntities3())
                    {
                        ...
                        foreach (yh_jinxiaocun_jinhuofang item in list)
                        {
                            sql += "insert into yh_jinxiaocun_jinhuofang_mssql(beizhu,lianxidizhi,lianxifangshi,finduser,gongsi) values (@beizhu" + paramIndex + ", @lianxidizhi" + paramIndex + ", @lianxifangshi" + paramIndex + ", @finduser" + paramIndex + ", @gongsi" + paramIndex + ");";
        ...
        public int update(string beizhu, string lianxidizhi, string lianxifangshi, string id)
        {
            if (HttpContext.Current != null && HttpContext.Current.Session["shujuku"] != null)
            {
                ...
                else if (shujukuValue == 1) // SQL Server
                {
                    using (yh_jinxiaocun_excelEntities3 sen = new yh_jinxiaocun_excelEntities3())
                    {
                        string sql = "UPDATE yh_jinxiaocun_jinhuofang_mssql SET beizhu = @beizhu, lianxidizhi = @lianxidizhi, lianxifangshi = @lianxifangshi WHERE _id = @id";
                        return sen.Database.ExecuteSqlCommand(sql,
                            new System.Data.SqlClient.SqlParameter("@beizhu", beizhu ?? ""),
