<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kucunjiya.aspx.cs" Inherits="Web.kucunjiya" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="d-header">
                ...
                <asp:TextBox ID='shuliang' class='select_input' Autocomplete='off' runat="server" placeholder="请输入积压数量临界值"/>
<%--                <asp:TextBox ID='shijian' class='select_input' Autocomplete='off' runat="server" placeholder="请输入积压时间临界值"/>   --%>
            ...
            <div class="d-main table_div">
                ...
                <tr id="dj_yh">
                    ...
                    <td class="auto-style1 qimo-column" style="width: 8%;">库存数量</td>
                    <td class="auto-style1 qimo-column" style="width: 8%;">库存金额</td>
                </tr>
                    <%
