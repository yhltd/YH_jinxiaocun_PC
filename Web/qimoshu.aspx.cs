...
namespace Web
{
    public partial class qimoshu : System.Web.UI.Page
    {
        // 添加日期控件的声明
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                try
                {
                    ...
                    if (list == null)
                    {
                        string startDate = Request.Form["time_qs"];
                        string endDate = Request.Form["time_jz"];
                        string cpname = Request.Form["qc_cx"];
                        string cangku = Request.Form["warehouse_select"];

                        JinChuModel jin = new JinChuModel();
                        Session["jichu"] = jin.getOutStockDetailQM(user.gongsi, startDate, endDate,cpname,cangku);
                    }
        ...
        private void shuaxin()
        {
            try
            {
                ...
                JinChuModel jin = new JinChuModel();
                List<QiChuQiMoShuItem> list = jin.getOutStockDetailQM(user.gongsi, startDate, endDate, cpname,cangku);
