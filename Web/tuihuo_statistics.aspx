<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tuihuo_statistics.aspx.cs" Inherits="Web.tuihuo_statistics" %>
...
<%--            <button id="exportExcel" class="btn btn-success mr-2">
    ...
    <script>
        ...
        function loadReturnData() {
            ...
            $.ajax({
                url: 'tuihuo_statistics.aspx/GetAllSalesReturns',
                type: 'POST',
    ...
    function exportToExcel() {
        ...
        var url = 'tuihuo_statistics.aspx/ExportToExcel?startDate=' + encodeURIComponent(startDate || '') +
