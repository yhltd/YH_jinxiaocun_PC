           ...
           <%-- <asp:DropDownList CssClass="hidden_load" ID="DropDownList1" runat="server" OnLoad="jczl_select_load">
            ...
            <table cellspacing="0" cellpadding="0" id="biao_ge" name="bg_row" style="">
                ...
                <tr id="del_row_cs<%=i%>">
                    ...
                    <td class="bg_bj">
                        <input type="text" style="width: 165px;" class="input_tr" id="Text1" name="name_cs<%=i%>" value="<%=jczj_select[i].name%>" /></td>
                    <td class="bg_bj">
                        <input type="text" style="width: 165px;" class="input_tr" id="Text2" name="lei_bie_cs<%=i%>" value="<%=jczj_select[i].lei_bie%>" /></td>
                    <td class="bg_bj">
                        <input type="text" style="width: 165px;" class="input_tr" id="ck_dj<%=i%>" name="dan_wei_cs<%=i%>" value="<%=jczj_select[i].dan_wei%>" /></td>
                    <td class="bg_bj">
                        <input type="text" style="width: 165px;" class="input_tr" id="Text5" name="shou_huo_cs<%=i%>" value="<%=jczj_select[i].shou_huo%>" /></td>
                    <td class="bg_bj">
                        <input type="text" style="width: 165px;" class="input_tr" id="Text4" name="gong_huo_cs<%=i%>" value="<%=jczj_select[i].Gong_huo%>" /></td>
                    <td class="bg_bj" style="border-right: 1px dashed #a8a8a8;">
                        <input type="hidden" class="input_tr" id="Text3" name="id_cs<%=i%>" value="<%=jczj_select[i].id%>" /><input id="checkbox" style="margin-left: 30%;" name="Checkbox_bd<%=i%>" value=" <%=i%>" type="checkbox" /></td>
