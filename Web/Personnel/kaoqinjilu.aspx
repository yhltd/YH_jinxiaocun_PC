...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Height="30px" Text="年份：" Width="80px"></asp:Label>
    
        <asp:DropDownList ID="DropDownList1" runat="server" Height="30px" Width="150px"  CssClass="top_select_input" >
        ...
        <asp:Label ID="Label2" runat="server" Height="30px" Text="月份：" Width="80px"></asp:Label>
        <asp:DropDownList ID="DropDownList2" runat="server" Height="30px" Width="150px"  CssClass="top_select_input" >
        ...
        <asp:Button ID="Button1" runat="server" Height="30px" Text="搜索" Width="80px" OnClick="Button1_Click" CssClass="top_bt" />
        <asp:Button ID="Button2" runat="server" Height="30px" Text="添加" Width="80px" OnClick="Button2_Click" CssClass="top_bt" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" AllowPaging="True"  OnRowCreated="aaa">
            <Columns>
                ...
                <asp:BoundField DataField="D" HeaderText="月" SortExpression="D"   ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="E" HeaderText="应到" SortExpression="E"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="F" HeaderText="实到" SortExpression="F"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="G" HeaderText="请假" SortExpression="G"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="H" HeaderText="加班" SortExpression="H"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="I" HeaderText="迟到" SortExpression="I"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="J" HeaderText="部门" SortExpression="J"  ControlStyle-Width="80%" >
                    <HeaderStyle HorizontalAlign="Center"  Width="11%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
