    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="rq_css" style="margin-left: 63%; margin-top: -2.2%; margin-bottom: -8%;">
                ...
                <asp:Button ID="Button3" class="rk_btu" OnClick="rq_select" Text="日期查询" runat="server" />
            </div>
            ...
            <table cellspacing="0" cellpadding="0" id="biao_ge" name="bg_row" style="margin-top: 8%;">
                <tr id="dj_yh">
                    ...
                    <td class="auto-style1" style="width: 83px; padding-left: 1%;">商品售价</td>
                    <td class="auto-style1" style="width: 83px; padding-left: 1%;">商品数量</td>
