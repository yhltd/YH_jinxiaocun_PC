<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caigoutuihuo.aspx.cs" Inherits="Web.caigoutuihuo" %>
...
<body>
        ...
        <div>
            ...
            <div class="d-main" id="table_div">
                ...
                <table id="biao_ge" name="bg_row" cellspacing="0" cellpadding="0">
                    <tr id="dj_yh">
                        <td class="auto-style1" style="width: 10%">采购退货</td>
    ...
    <div class="ruku_div" style="display:none">
        <div style="margin-bottom: 10px;">
            ...
            <input class="order_id_input" placeholder="退货单号" style="width: 190px;margin-left: 40px;" value=""/>
        </div>
        <div style="margin-bottom: 10px;">
