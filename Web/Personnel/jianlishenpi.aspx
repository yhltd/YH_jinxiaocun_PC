<%@ page language="C#" autoeventwireup="true" codebehind="jianlishenpi.aspx.cs" inherits="Web.Personnel.jianlishenpi" %>
...
<body style="margin: 0;">
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            window.open('jianlishenpi.aspx?action=export');
        }
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div style="background: #fffbe6; border: 1px solid #ffe58f; padding: 10px 30px; margin: 0 10px 20px 10px; border-radius: 0 0 1px 12px; color: #856404; font-size: 14px; border-left: 5px solid #ffe58f;">
                <strong>使用说明：</strong> 简历审批显示“待处理”简历。状态改为“驳回”将返回到简历管理页面，选择“通过”则提交到面试管理页面。
            </div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT id, touliren, xueli, mubiaogangwei, tijiaoshijian, wenjian, beizhu, zhuangtai FROM gongzi_jianliguanli WHERE gongsi = @gongsi AND zhuangtai = '待处理' ORDER BY id DESC">
                <SelectParameters>
