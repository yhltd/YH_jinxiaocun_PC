...
function setTable(data) {
    $('#data-table').datagrid({
        ...
        columns: [[
            ...
            { field: 'ying', align: 'center', title: '应付', width: 115 },
            { field: 'shi', align: 'center', title: '实付', width: 115 },
            { field: 'wei', align: 'center', title: '未付', width: 115 },
        ]]
    })
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (result.code == 200) {
                ...
                console.log(header)
                title = ['日期', '客户', '科目', '项目', '应付', '实付', '未付']
                JSONToExcelConvertor(header, "应付明细帐", title)
            }
        },
        error: function (err) {
            alert("错误！")
