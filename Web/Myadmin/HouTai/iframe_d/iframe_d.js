...
function iframe_d_open(list) {
    ...
    if (list.maxmin) {
        iframe_d_html +=
                    "<img id='iframe_d_header_fun_maxmin' onclick='javascript:iframe_d_header_fun_maxmin()' class='iframe_d_header_fun_img' src='iframe_d/img/放大.png'/>"
    }

    iframe_d_html +=
                    "<img id='iframe_d_header_fun_close' onclick='javascript:iframe_d_close()' class='iframe_d_header_fun_img' src='iframe_d/img/关闭.png'/>" +
                "</div>" +
            "</div>" +
