    ...
    public partial class kaoqinUpd : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (Request.Form["TextBox1"] != "" && Request.Form["TextBox2"] != "" && Request.Form["TextBox3"] != "" && Request.Form["TextBox1"] != " " && Request.Form["TextBox2"] != " " && Request.Form["TextBox3"] != " ")
            {
                ...
                string sqlStr = "update gongzi_kaoqinjilu set year='" + Request.Form["TextBox1"] + "',moth='" + Request.Form["TextBox2"] + "',name='" + Request.Form["TextBox3"] + "',E='" + Request.Form["TextBox4"] + "',F='" + Request.Form["TextBox5"] + "',G='" + Request.Form["TextBox6"] + "',H='" + Request.Form["TextBox7"] + "',I='" + Request.Form["TextBox8"] + "',J='" + Request.Form["TextBox9"] + "',K='" + Request.Form["TextBox10"] + "',L='" + Request.Form["TextBox11"] + "',M='" + Request.Form["TextBox12"] + "',N='" + Request.Form["TextBox13"] + "',O='" + Request.Form["TextBox14"] + "',P='" + Request.Form["TextBox15"] + "',Q='" + Request.Form["TextBox16"] + "',R='" + Request.Form["TextBox17"] + "',S='" + Request.Form["TextBox18"] + "',T='" + Request.Form["TextBox19"] + "',U='" + Request.Form["TextBox20"] + "',V='" + Request.Form["TextBox21"] + "',W='" + Request.Form["TextBox22"] + "',X='" + Request.Form["TextBox23"] + "',Y='" + Request.Form["TextBox24"] + "',Z='" + Request.Form["TextBox25"] + "',AA='" + Request.Form["TextBox26"] + "',AB='" + Request.Form["TextBox27"] + "',AC='" + Request.Form["TextBox28"] + "',AD='" + Request.Form["TextBox29"] + "',AE='" + Request.Form["TextBox30"] + "',AF='" + Request.Form["TextBox31"] + "',AG='" + Request.Form["TextBox32"] + "',AH='" + Request.Form["TextBox33"] + "',AI='" + Request.Form["TextBox34"] + "',AJ='" + Request.Form["TextBox35"] + "',AK='" + Request.Form["TextBox36"] + "',AL='" + Request.Form["TextBox37"] + "',AM='" + Request.Form["TextBox38"] + "',AN='" + Request.Form["TextBox39"] + "' where id='" + bb[39] + "'";
