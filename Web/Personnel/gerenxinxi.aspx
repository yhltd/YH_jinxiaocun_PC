...
<body style="    margin: 0;">
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" Text="搜索" OnClick="Button1_Click"   CssClass="top_bt" ClientIDMode="AutoID" Height="30px" Width="80px" />
        <asp:Button ID="Button2" runat="server" Text="所有" OnClick="Button2_Click" CssClass="top_bt" />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="E" HeaderText="身份证号" SortExpression="E" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="F" HeaderText="基本工资" SortExpression="F" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="G" HeaderText="银行卡号" SortExpression="G" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="H" HeaderText="入职时间" SortExpression="H" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="I" HeaderText="账号" SortExpression="I" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="J" HeaderText="密码" SortExpression="J" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="K" HeaderText="工龄/年" SortExpression="K" ControlStyle-Width="80%">
                    <HeaderStyle HorizontalAlign="Center"  Width="10%"/>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
