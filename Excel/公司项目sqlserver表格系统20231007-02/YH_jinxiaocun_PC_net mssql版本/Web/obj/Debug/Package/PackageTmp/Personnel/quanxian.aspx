...
<body style="    margin: 0;">
    ...
    <div class="first">
        <div class="two">
            <asp:Label ID="Label43" runat="server" Text="考勤：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label44" runat="server" Text="人员信息管理：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label45" runat="server" Text="工资明细：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label46" runat="server" Text="考勤记录：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label47" runat="server" Text="配置表：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label48" runat="server" Text="报盘：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label49" runat="server" Text="报税：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label50" runat="server" Text="部门汇总：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label51" runat="server" Text="社保：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label52" runat="server" Text="个人信息：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label53" runat="server" Text="个人所得税：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <asp:Label ID="Label54" runat="server" Text="工资条：" Height="40px" Width="200px" style="text-align:center"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
