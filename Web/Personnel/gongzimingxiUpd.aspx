...
<body style="margin: 0;" runat="server" >
    <form id="form1" runat="server">
        <div id="Div1" runat="server" style="height: 600px; width: 1400px;overflow-x:scroll" >
            ...
            <asp:Label ID="Label41" runat="server" Text="滞纳金" Width="115px" Height="30px"></asp:Label>
            ...
            <asp:Label ID="Label42" runat="server" Text="利息" Width="115px" Height="30px"></asp:Label>
            ...
            <br />
            <asp:Label ID="Label32" runat="server" Text="滞纳金" Width="115px" Height="30px"></asp:Label>
            ...
            <asp:Label ID="Label33" runat="server" Text="利息" Width="115px" Height="30px"></asp:Label>
