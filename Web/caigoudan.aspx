<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caigoudan.aspx.cs" Inherits="Web.caigoudan" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#insert_ruku").click(function () {
                ...
                var rukuStatus = $("#ruku_status").val(); // 获取是否入库的值

                ruku.Rwarehouse = Rwarehouse;
                ruku.rukuStatus = rukuStatus; // 添加到ruku对象中
        ...
        function loadWarehouseOptionsForPrint() {
            ...
            warehouseSelect.append('<option value="">请选择采购仓库</option>');
        ...
        function generatePrintContent() {
            ...
            var printHtmlArray = [
                ...
                '        <p style="margin: 5px 0;">目标仓库: ' + warehouse + '</p>',
                '    </div>',
                '    ',
...
<body>
    ...
    <div style="height: 30%;margin-bottom: 10px;" class="ruku_info_div">
        <div>
            <label style="font-size: 14px; color: #333; margin-bottom: 5px; display: block;margin-left: 40px;">目标仓库</label>
            <select id="ruku_warehouse" style="margin-left: 40px;width: 200px;height: 30px;border: none;border: 1px solid #F0F0F0;">
            </select>
        </div>
        
        <div>
            <label style="font-size: 14px; color: #333; margin-bottom: 5px; display: block;margin-left: 40px;">是否入库</label>
            <select id="ruku_status" style="margin-left: 40px;width: 200px;height: 30px;border: none;border: 1px solid #F0F0F0;">
    ...
    <div class="ruku_bottom_div">
        ...
        <input class="rk_bt" id="insert_ruku" type="button" value="确认"/>
    </div>
</div>
    ...
    <div class="print_info_dialog" style="display:none; width: 50%; height: 60%; position: fixed; top: 10%; left: 25%; background-color: white; z-index: 22; box-shadow: 10px 10px 15px; border-radius: 2px; padding: 20px; overflow-y: auto;">
        ...
        <div id="print_info_content" style="background-color: white; padding: 20px;">
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" id="print_order_id" class="print_input" placeholder="请输入采购单号" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 3px;" />
            </div>
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 5px; font-weight: bold;">目标仓库:</label>
