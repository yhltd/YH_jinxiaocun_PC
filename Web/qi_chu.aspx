        ...
        $(document).ready(function () {
            ...
            $("#dj_yh").click(function () {
                ...
                var insertStr = "<tr id='del_row" + row + "' >"
                               ...
                               + "<td ><input type='text' class='input_tr' style='width:147px;margin:1px'  id='sp_name' name='cpid" + row + "' ></input></td>"
                               + "<td class='bg_bj_dm'><input type='text' style='width:318px;margin:1px' id='sp_dm' class='input_tr' name='cpname" + row + "' ></input></td>"
                               + "<td class='bg_bj_lb'><input type='text' style='width:147px;margin:1px' id='sp_cplb' class='input_tr' name='cplb" + row + "' ></input></td>"
        ...
        <div>
            ...
            <table cellspacing="0" cellpadding="0" id="biao_ge" name="bg_row" style="margin-top: 8%;">
                <tr id="dj_yh">
                    ...
                    <td class="auto-style1" style="padding-left: 1%; width: 148px; font-size: 92%">商品代码</td>
                    <td class="auto-style1" style="padding-left: 1%; width: 321px; font-size: 92%">商品名称</td>
