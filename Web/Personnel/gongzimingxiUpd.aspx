...
<body style="margin: 0;" runat="server" >
    <form id="form1" runat="server">
        <div id="Div1" runat="server" style="height: 600px; width: 1400px;overflow-x:scroll" >
            ...
            <input runat="server" id="input15" class="top_option" type="number" />
            ...
            <input runat="server" id="input53" class="top_option" type="date" />
            ...
            <input runat="server" id="input54" class="top_option" type="date" />
