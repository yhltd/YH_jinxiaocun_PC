...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kh_ming_xi_selcet_dayin.aspx.cs" Inherits="Web.RDLC.kh_ming_xi_selcet_dayin" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer4" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="1000px" Width="1000px">
