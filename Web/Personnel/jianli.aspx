<%@ page language="C#" autoeventwireup="true" codebehind="jianli.aspx.cs" inherits="Web.Personnel.jianli" %>
...
<body style="margin: 0;">
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            window.open('jianli.aspx?action=export');
        }
        ...
        // 显示编辑弹窗 - 编辑所有字段
        function showEditModal(id, touliren, xueli, mubiaogangwei, tijiaoshijian, beizhu, zhuangtai) {
            // 防止事件冒泡
            if (event) {
                event.stopPropagation();
                event.preventDefault();
            ...
            console.log('编辑数据:', {id, touliren, xueli, mubiaogangwei, tijiaoshijian, beizhu, zhuangtai}); // 调试用
            ...
            if (tijiaoshijian) {
                ...
                var datePart = tijiaoshijian.split(' ')[0]; // 分离日期和时间部分
        ...
        function saveAllEdit() {
            ...
            // 确保日期格式正确（虽然type="date"会自动格式化为yyyy-MM-dd，但这里确保一下）
            if (tijiaoshijian) {
                // 如果需要，可以在这里验证日期格式
                console.log('提交时间:', tijiaoshijian); // 调试用
            }
        ...
        function showAddModal() {
            ...
            $('#addBeizhuModal').val('');
            $('#addZhuangtaiModal').val('待处理'); // 默认状态
        ...
        function searchRecords() {
            ...
            console.log('查询条件:', { touliren: touliren, xueli: xueli, zhuangtai: zhuangtai });
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div class="header-top">
                ...
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 5px;">
                        ...
                        <select id="searchZhuangtai" style="padding: 5px 10px; border: 1px solid #ddd; border-radius: 4px; width: 100px;">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="状态" ItemStyle-Width="120">
                        <ItemTemplate>
                            <span  style="cursor: pointer; ">
                                <%# Eval("zhuangtai") %>
                            </span>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT id, touliren, xueli, mubiaogangwei, tijiaoshijian, wenjian, beizhu, zhuangtai FROM gongzi_jianliguanli WHERE gongsi = @gongsi AND (zhuangtai IS NULL OR zhuangtai = '' OR zhuangtai = '待处理' OR zhuangtai = '驳回') ORDER BY id DESC">
                <SelectParameters>
       ...
       <!-- 批量编辑模态框 -->
        <div id="editAllModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">编辑简历信息</div>
                <div class="modal-body">
                    <!-- 这里需要一个隐藏字段来存储记录ID -->
        ...
        <div id="addModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">添加简历信息</div>
                <div class="modal-body">
                    <div style="margin-bottom: 15px;">
                        <label>投历人名：</label>
