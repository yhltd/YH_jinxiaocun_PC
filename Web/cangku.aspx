<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cangku.aspx.cs" Inherits="Web.cangku" %>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var insertStr = "<tr id='del_row" + row + "' >"
                               ...
                               + "<td ><input type='text' class='input_tr' style='width: 150px;margin:0.2%;' name='cangku" + row + "' ></input></td>"
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="top-div">
                <asp:TextBox ID='kh_cx' class='select_input' Autocomplete='off'  runat="server" placeholder="按仓库名称查询"/>
            ...
            <div class="table_div">
                <table cellspacing="0" cellpadding="0" id="biao_ge" name="bg_row" style="width: 100%">
                    <tr id="dj_yh">
                        ...
                        <th class="auto-style1" style="width: 200px">仓库名称</th>
                        <th class="auto-style1" style="width: 50px">功能</th>
                    </tr>
                    <%
                        System.Collections.Generic.List<Web.Server.yh_jinxiaocun_cangku> cangkuList = Session["kehu_select"] as System.Collections.Generic.List<Web.Server.yh_jinxiaocun_cangku>;
                        if (cangkuList != null)
                        {
                    ...
                    <tr id="del_row_cs<%=i %>">
                        ...
                        <td class="bg_bj">
                            <input type="text" class="input_tr" id="cangku" name="cangku_cs<%=i %>" value="<%=cangkuList[i].cangku %>" /></td>
                        <td class="bg_bj">
                            <input type="hidden" class="input_tr" id="Text3" name="id_cs<%=i %>" value="<%=cangkuList[i].id %>" />
