    ...
    <div id="main" class="item">
        <div class="main-item">
            ...
            <div class="main-item-item">
                ...
                <div id="upd-financingExpenditure-window" style="display: none">
                ...
                <div id="add-financingExpenditure-window" style="display: none">
            ...
            <div class="main-item-item btn-right">
                <div id="data-table-financingIncome" class="easyui-datagrid"></div>
                <div id="data-page-financingIncome" class="easyui-pagination"></div>
                <div id="upd-financingIncome-window" style="display: none">
                ...
                <div id="add-financingIncome-window" style="display: none">
            ...
            <!--筹资收入-->
            <div class="main-item-item btn-right">
                <div id="data-table-investmentExpenditure" class="easyui-datagrid"></div>
                <div id="data-page-investmentExpenditure" class="easyui-pagination"></div>
                <div id="upd-investmentExpenditure-window" style="display: none">
                ...
                <div id="add-investmentExpenditure-window" style="display: none">
            ...
            <!--筹资支出-->
            <div class="main-item-item btn-right">
                <div id="data-table-investmentIncome" class="easyui-datagrid"></div>
                <div id="data-page-investmentIncome" class="easyui-pagination"></div>
                <div id="upd-investmentIncome-window" style="display: none">
                ...
                <div id="add-investmentIncome-window" style="display: none">
            ...
            <!--投资收入-->
            <div class="main-item-item btn-right">
                <div id="data-table-managementExpenditure" class="easyui-datagrid"></div>
                <div id="data-page-managementExpenditure" class="easyui-pagination"></div>
                <div id="upd-managementExpenditure-window" style="display: none">
                ...
                <div id="add-managementExpenditure-window" style="display: none">
            ...
            <!--投资支出-->
            <div class="main-item-item btn-right">
                <div id="data-table-managementIncome" class="easyui-datagrid"></div>
                <div id="data-page-managementIncome" class="easyui-pagination"></div>
                <div id="upd-managementIncome-window" style="display: none">
                ...
                <div id="add-managementIncome-window" style="display: none">
            ...
            <!--凭证字-->
            <div class="main-item-item btn-right">
                <div id="data-table-voucherWord" class="easyui-datagrid"></div>
                <div id="data-page-voucherWord" class="easyui-pagination"></div>
                <div id="upd-voucherWord-window" style="display: none">
                ...
                <div id="add-voucherWord-window" style="display: none">
